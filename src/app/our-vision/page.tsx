...
export default function OurVision() {
  return (
    <div className="flex flex-col items-center justify-center pt-16 md:pt-24 lg:pt-32 px-4 md:px-6 max-w-7xl mx-auto overflow-hidden">
      {/* ──────────────────────────────────────────────────────────────
         HERO SECTION — Brand introduction with editorial imagery
         ────────────────────────────────────────────────────────────── */}
      <section className="relative w-full text-center space-y-16 md:space-y-20 lg:space-y-24 mb-24 md:mb-32" aria-labelledby="hero-heading">
        ...
        >
          ...
          <p className="text-[10px] md:text-[11px] lg:text-xs font-bold uppercase tracking-[0.4em] md:tracking-[0.5em] lg:tracking-[0.6em] opacity-25 max-w-md mx-auto leading-relaxed">
        ...
        >
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
            <span className="text-[9px] md:text-[10px] lg:text-xs font-bold uppercase tracking-[0.6em] md:tracking-[0.8em] lg:tracking-[1em] opacity-40 text-white drop-shadow-xl">LYVRA · 2026</span>
        ...
        >
          <Link
            href="/the-studio"
            className="group relative inline-flex items-center gap-8 md:gap-12 px-12 md:px-16 lg:px-20 py-5 md:py-6 lg:py-8 border border-primary/20 hover:border-primary/60 transition-all duration-1000 rounded-full cursor-pointer"
            aria-label="Apply to The Studio — Start your custom journey"
          >
            <span className="relative z-10 text-[10px] md:text-xs lg:text-sm font-bold uppercase tracking-[0.5em] md:tracking-[0.6em] lg:tracking-[0.8em] group-hover:tracking-[0.6em] md:group-hover:tracking-[0.8em] lg:group-hover:tracking-[1em] transition-all duration-700">Enter the Studio</span>
            <motion.div
      ...
      {/* ──────────────────────────────────────────────────────────────
         OUR VISION CONTENT — Sustainability story section
         ────────────────────────────────────────────────────────────── */}
      <section className="w-full py-20 md:py-28 lg:py-40 space-y-24 md:space-y-32 lg:space-y-40 border-t border-border/50" aria-labelledby="vision-heading">
        ...
        {/* Opening Statement — Image Left, Text Right */}
        <FadeIn delay={0.1}>
        ...
        {/* Second Statement — Text Left, Image Right */}
        <FadeIn delay={0.2}>
          <div className="grid md:grid-cols-2 gap-10 md:gap-14 lg:gap-20 xl:gap-24 items-center">
