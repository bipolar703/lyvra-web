  ...
  return (
    <div className="container mx-auto px-4 md:px-6 py-16 md:py-24 lg:py-32 max-w-4xl relative z-10">
      <header className="space-y-8 md:space-y-10 mb-20 md:mb-24 lg:mb-32">
        <h1 className="font-script text-5xl md:text-7xl lg:text-8xl xl:text-[10rem] tracking-tight uppercase italic leading-[0.9] opacity-90 animate-fade-in">
          The Studio
        </h1>
        ...
        <p className="text-sm md:text-base lg:text-lg font-medium leading-relaxed md:leading-loose max-w-2xl opacity-60 animate-fade-in-delay-2">
        ...
        <div className="flex flex-wrap gap-4 md:gap-6 pt-4 animate-fade-in-delay-3">
          <a 
            href="#application"
            className="text-[10px] md:text-xs font-bold uppercase tracking-[0.4em] md:tracking-[0.6em] opacity-40 hover:opacity-70 transition-opacity duration-500 flex items-center space-x-2"
